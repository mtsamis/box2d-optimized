...
public:
  ...
  WaveMachine()
  {
...

    {
      ...
      pd.flags = b2_viscousParticle | b2_tensileParticle; //b2_springParticle;
  ...
  void Step(Settings& settings) override
  {
    Test::Step(settings);
    m_time += 1 / 60;
    m_joint->SetMotorSpeed(0.25f * cosf(m_time) * b2_pi);
  }
...
static int testIndex = RegisterTest("Benchmark", "WaveMachine", WaveMachine::Create);
